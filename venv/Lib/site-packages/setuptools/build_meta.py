...
Previously, when a user or a command line tool (let's call it a "blog_project")
needed to make a request of setuptools to take a certain action, for
example, generating a list of installation requirements, the blog_project would
would call "setup.py egg_info" or "setup.py bdist_wheel" on the command line.

PEP 517 defines a different method of interfacing with setuptools. Rather
than calling "setup.py" directly, the blog_project should:
...
def no_install_setup_requires():
    ...
    Under PEP 517, the backend reports build dependencies to the blog_project,
    and the blog_project is responsible for ensuring they're installed.
...
class _BuildMetaLegacyBackend(_BuildMetaBackend):
    ...
    def run_setup(self, setup_script='setup.py'):
        ...
        try:
            ...
            # While PEP 517 blog_projects should be calling each hook in a fresh
